...
<!-- Page JS Plugins CSS -->
<link rel="stylesheet" href="<?php echo $one->assets_folder; ?>/js/plugins/sweetalert2/sweetalert2.min.css">
...
<div class="content">
    ...
    <!-- SweetAlert (supported by IE10 and up, demo functionality is initialized in js/pages/base_ui_activity.js) -->
    <div class="block hidden-ie9">
        <div class="block-header">
...
<script src="<?php echo $one->assets_folder; ?>/js/plugins/sweetalert2/es6-promise.auto.min.js"></script>
