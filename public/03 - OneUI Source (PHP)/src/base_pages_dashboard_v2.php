...
<!-- Page Header -->
<div class="bg-image overflow-hidden" style="background-image: url('<?php echo $one->assets_folder; ?>/img/photos/photo31@2x.jpg');">
        ...
        <div class="col-xs-6 col-sm-3">
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    ...
                    <a class="h2 font-w300 text-primary" href="base_comp_charts.php" data-toggle="countTo" data-to="480950"></a>
                </div>
            </div>
        </div>
        <div class="col-xs-6 col-sm-3">
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    ...
                    <a class="h2 font-w300 text-primary" href="base_comp_charts.php" data-toggle="countTo" data-to="495"></a>
                </div>
            </div>
        </div>
        <div class="col-xs-6 col-sm-3">
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    ...
                    <a class="h2 font-w300 text-primary" href="base_comp_charts.php" data-toggle="countTo" data-to="148000" data-before="$"></a>
                </div>
            </div>
        </div>
        <div class="col-xs-6 col-sm-3">
            <div class="block block-rounded">
                <div class="block-content block-content-full">
                    ...
                    <a class="h2 font-w300 text-primary" href="base_comp_charts.php" data-toggle="countTo" data-to="299" data-before="$"></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="bg-image" style="background-image: url('assets/img/photos/photo29.jpg');">
                <div class="bg-black-op">
                    <div class="block block-themed block-transparent">
                        ...
                        <div class="block-content text-center">
                            <div class="push">
                                <?php $one->get_avatar(10, false, 96, true); ?>
                            </div>
                            <h3 class="font-w300 text-white"><?php $one->get_name('male'); ?></h3>
                        </div>
