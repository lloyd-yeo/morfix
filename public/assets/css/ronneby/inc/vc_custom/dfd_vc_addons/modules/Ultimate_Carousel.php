...
*/
if(!class_exists("Dfd_Old_Carousel")){
	class Dfd_Old_Carousel{
...
//			}
		...
		function ultimate_front_scripts(){
			wp_register_script("ult-slick",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/min-js/slick.min.js',array('jquery'),null,false);
			wp_register_script("ult-slick-custom",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/min-js/slick.custom.min.js',array('jquery','ult-slick'),null,false);
		}
		
		function ultimate_admin_scripts($hook){
			if($hook == "post.php" || $hook == "post-new.php"){
				wp_enqueue_style("ult-icons", get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/slick/icons.css');
			}
		}
		...
		function ultimate_carousel_shortcode($atts, $content) {
			...
			$arr_style .= 'color:'.esc_attr($arrow_color).'; font-size:'.esc_attr($arrow_size).'px;';
