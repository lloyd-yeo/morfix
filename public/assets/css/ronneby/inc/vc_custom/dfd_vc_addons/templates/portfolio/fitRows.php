...
if(isset($items_offset)) {
	$css_rules .= '#'.$uniqid.' .dfd-portfolio {margin: -'.esc_attr($items_offset/2).'px;}';
	$css_rules .= '#'.$uniqid.' .dfd-portfolio .cover {padding: '.esc_attr($items_offset/2).'px;}';
	$css_rules .= '#'.$uniqid.'.dfd-portfolio-loop .dfd-portfolio .project .cover .dfd-folio-heading-wrap {left: '.esc_attr($items_offset/2).'px;right: '.esc_attr($items_offset/2).'px;}';
}
