...
<div class="dfd-gallery-loop dfd-gallery-module <?php echo esc_attr($el_class) ?>" id="<?php echo esc_attr($uniqid) ?>">
	<div class="dfd-gallery-wrap">
		<?php
			if($sort_panel)
				include(locate_template('inc/vc_custom/dfd_vc_addons/templates/gallery/template_parts/sort-panel.php'));
		?>
		
		<div class="dfd-gallery dfd-gallery-<?php echo esc_attr($style .' '.$extra_class_name .' '. $anim_class) ?>" <?php echo $data_atts ?>>
		<?php
			...
			while ($wp_query->have_posts()) : $wp_query->the_post();
				...
				if($sort_panel)
					include(locate_template('inc/vc_custom/dfd_vc_addons/templates/gallery/template_parts/article_data_atts.php'));
				?>
