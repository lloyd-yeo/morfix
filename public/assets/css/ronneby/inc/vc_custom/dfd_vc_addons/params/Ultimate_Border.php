	...
	class Ultimate_Border {
		function __construct() {
			...
			if(function_exists('vc_add_shortcode_param')) {
				vc_add_shortcode_param('ultimate_border', array($this, 'ultimate_border_callback'), get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/admin/vc_extend/js/ultimate-border.js');
			}
		}
		...
		function ultimate_border_callback($settings, $value) {
			...
			foreach($positions as $key => $default_value) {
				$dashicon = isset($dashicons_border_width[$key]) ? $dashicons_border_width[$key] : '';
				$html .= $this->ultimate_border_param_item($dashicon, /*$mode,*/ $unit, /*$default_value,*/$default_value, $key, 'border-' .strtolower($key). '-width');
			}
			...
			*---------------------------------------------------*/
			...
			$html .= '  <input type="hidden" data-unit="'.$unit.'" name="'.$settings['param_name'].'" class="wpb_vc_param_value ultimate-border-value '.$settings['param_name'].' '.$settings['type'].'_field" value="'.$value.'" />';
			$html .= '</div>';
			return $html;
		}
		...
		function ultimate_border_param_scripts($hook) {
			wp_register_style("ultimate-border-style",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/admin/vc_extend/css/ultimate_border.css');
