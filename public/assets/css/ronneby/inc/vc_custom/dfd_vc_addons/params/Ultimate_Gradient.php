	...
	class Ultimate_Gradient_Param {
		...
		function enqueue_scripts($hook) {
			if($hook == "post.php" || $hook == "post-new.php" || $hook == "edit.php"){
				wp_enqueue_script('jquery.colorpicker',get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/admin/js/jquery.colorpicker.js');
				wp_enqueue_script('jquery.classygradient',get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/admin/js/jquery.classygradient.min.js');			
			}
		}
