...
if(!class_exists('Ultimate_Google_Font_Manager'))
{
	class Ultimate_Google_Font_Manager
	{
		function __construct()
		{
			...
			{
				vc_add_shortcode_param('ultimate_google_fonts', array($this, 'ultimate_google_fonts_settings'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/vc-google-fonts-param.js');
		...
		{
			wp_register_script('ultimate-google-fonts-script',get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/js/google-fonts-admin.js',array('jquery'));
			wp_enqueue_script('ultimate-google-fonts-script');
			wp_register_style('ultimate-google-fonts-style',get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/css/google-fonts-admin.css', false, null);
		...
		?>
      	<div class="wrap uavc-gfont">
      		<h2>
					<?php _e('Google Fonts Manager','dfd'); ?>
					<input style="cursor:pointer" type="button" class="add-new-h2" id="refresh-google-fonts" value="<?php _e('Refresh Font List','dfd'); ?>"/>
									...
									?>
										<div class="selected-font">
											<div class="selected-font-top <?php echo (!empty($sfont['variants']) || !empty($sfont['subsets'])) ? 'have-variants' : ''; ?>">
												<div class="font-header" style="font-family:'<?php echo esc_attr($sfont['font_name']) ?>'"><?php echo $sfont['font_name'] ?></div>
											...
											<?php
												...
												<div class="selected-font-content">
                                                                ...
                                                                foreach($sfont['variants'] as $svkey => $svariants)
                                                                {
                                                                    ...
                                                                    ?>
                                                                        <span class="font-variant">
                                                                            <input type="checkbox" id="<?php echo esc_attr($tlid) ?>" value="<?php echo esc_attr($svariants['variant_value']) ?>" class="selected-variant-checkbox" <?php echo ($svariants['variant_selected'] == 'true') ? 'checked' : ''; ?> />
                                                                            <label style="<?php echo esc_attr($variant_style); ?>" for="<?php echo esc_attr($tlid) ?>"><?php echo $svariants['variant_value'] ?></label>
                                                                        </span>
                                                                    <?php
                                                                }
                                                                ?>
                                                                ...
                                                                foreach($sfont['subsets'] as $sbkey => $ssubset)
                                                                {
                                                                    ...
                                                                    ?>
                                                                        <span class="font-subset">
                                                                            <input type="checkbox" id="<?php echo esc_attr($slid) ?>" value="<?php echo esc_attr($ssubset['subset_value']) ?>" class="selected-subset-checkbox" <?php echo ($ssubset['subset_selected'] == 'true') ? 'checked' : '' ?> />
                                                                            <label style="" for="<?php echo esc_attr($slid) ?>"><?php echo $ssubset['subset_value'] ?></label>
                                                                        </span>
                                                                    <?php
                                                                }
                                                                ?>
                                                    ...
                                                    ?>
													<input type="button" class="button alignleft update-google-font-button" value="Update font" data-font_name="<?php echo esc_attr($sfont['font_name']) ?>" />
