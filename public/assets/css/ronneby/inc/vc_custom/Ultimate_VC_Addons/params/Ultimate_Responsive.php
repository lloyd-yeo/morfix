	...
	class Ultimate_Responsive {
		function __construct() {
			...
			if(function_exists('vc_add_shortcode_param')) {
				vc_add_shortcode_param('ultimate_responsive', array($this, 'ultimate_responsive_callback'), get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/js/ultimate-responsive.js');
			}
		}
		...
		function ultimate_responsive_callback($settings, $value)
		{
			...
			$html .= '  <input type="hidden" data-unit="'.$unit.'"  name="'.$settings['param_name'].'" class="wpb_vc_param_value ultimate-responsive-value '.$settings['param_name'].' '.$settings['type'].'_field" value="'.$value.'" />';
		...
		function ultimate_admin_responsive_param_scripts($hook) {
			...
			wp_register_style('ultimate_responsive_param_css', get_template_directory_uri().'/inc/vc_custom/Ultimate_VC_Addons/admin/vc_extend/css/ultimate_responsive.min.css');
...
if(!function_exists('get_ultimate_vc_responsive_media_css')) {
