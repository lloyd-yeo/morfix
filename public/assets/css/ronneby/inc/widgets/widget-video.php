...
class crum_video_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'crum_widgets_video', // Base ID
            'Widget: oEmbed Video', // Name
            array(
                'description'	=> __( 'Include video with oEmbed', 'dfd' )
            ) // Args
        );
    }
    ...
    <p>
        ...
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'embed_url' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'embed_url' )); ?>" type="text" value="<?php echo esc_attr($instance['embed_url']) ?>" />
    </p>
    <p>
