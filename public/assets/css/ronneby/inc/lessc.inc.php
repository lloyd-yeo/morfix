...
class lessc {
	...
	public function compileFile($fname, $outFname = null,$options=array()) {
		if (!is_readable($fname)) {
			throw new Exception('load error: failed to find '.$fname);
		}
		$append = (isset($options["append"]) && $options["append"]==true) ? FILE_APPEND : FILE_USE_INCLUDE_PATH;
		$pi = pathinfo($fname);
		...
		if ($outFname !== null) {
			return file_put_contents($outFname, $out,$append);
		}
