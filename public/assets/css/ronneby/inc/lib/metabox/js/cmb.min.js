...
(function($) {
	...
	$(document).ready(function() {
		//if($('body').hasClass('post-type-page') || $('body').hasClass('post-type-my-product') || $('body').hasClass('post-type-post') || $('body').hasClass('post-type-gallery') || $('body').hasClass('post-type-product')) {
				...
				$('.cmb_metabox > tbody > tr', $metaboxWrap).each(function() {
					...
					if(dataOption && dataOption != '' && dataValue && dataValue != '') {
						var showHideBoxes = function() {
							var currentValue = $('#' + dataOption).val(),
						...
						showHideBoxes();
						$metaboxWrap.on('change', '#' + dataOption, function() {
							showHideBoxes();
						});
					}
				});
			...
			if($('body').hasClass('post-type-page') || $('body').hasClass('post-type-post') || $('body').hasClass('post-type-my-product') || $('body').hasClass('post-type-gallery') || $('body').hasClass('post-type-product')) {
				var $metaBoxes				= $('#normal-sortables').children('.postbox:not(#wpb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta)').clone(),
					$advancedContainer		= $('#advanced-sortables');
				$('#normal-sortables').children('.postbox:not(#wpb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta)').remove();
				$metaBoxes.appendTo($advancedContainer);
				$advancedContainer.wrapInner('<div class="dfd-metaboxes-wrap" />').prepend('<div class="dfd-metaboxes-titles" />');
...
(function($) {
	'use strict';
	$(document).ready(function() {
		var enableDots = $('#dfd_enable_dots').parents('tr'),
			dropdown = $('#dfd_animation_style');
