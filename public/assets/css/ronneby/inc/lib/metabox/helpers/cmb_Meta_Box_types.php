...
class cmb_Meta_Box_types {
	...
	public function icon() {
		return $this->input( array( 'class' => 'iconname', 'desc' => '<a href="#" class="button crum-icon-add" title="'.__('Add Icon', 'dfd').'">'.__('Add Icon', 'dfd').'</a>','<p class="cmb_metabox_description">'.$this->_desc() ) );
	}
