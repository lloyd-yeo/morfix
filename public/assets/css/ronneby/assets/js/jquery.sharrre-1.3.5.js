...
(function ($, window, document, undefined) {
	...
	popup = {
		...
		stumbleupon: function (opt) {
			window.open('//www.stumbleupon.com/badge/?url=' + encodeURIComponent((opt.buttons.stumbleupon.url !== '' ? opt.buttons.stumbleupon.url : opt.url)), 'stumbleupon', 'toolbar=no,width=550,height=550');
		},
