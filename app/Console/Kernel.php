...
class Kernel extends ConsoleKernel {
    ...
    protected function schedule(Schedule $schedule) {
		...
		$schedule->command("paypal:updatechargesdaily")->twiceDaily(5, 17)->withoutOverlapping();
	    $schedule->command("braintree:listtransactions")->twiceDaily(4, 16)->withoutOverlapping();
	    $schedule->command("stripe:getinvoice")->twiceDaily(3, 15)->withoutOverlapping();
    }
