...
class InteractionsController extends Controller {
    ...
    public function saveComment(Request $request, $id) {
        ...
        $instagram_comment = \App\InstagramProfileComment::whereRaw("comment LIKE \"" . $request->input('comment')  . "\"  COLLATE utf8_general_ci AND insta_username = \"" . $instagram_profile->insta_username . "\"")->first();
        $response = "There has been an error with the server. Please contact live support.";
