...
if (!function_exists('getFollowProfiles')) {
    ...
    function getFollowProfiles($email, $servername, $username, $password, $dbname) {
        ...
        $stmt_get_profile->bind_result($insta_username, $insta_user_id, $id, $insta_pw, $niche, $next_follow_time, $unfollow, $follow_cycle, $auto_unfollow, $auto_follow, $auto_follow_ban, $auto_follow_ban_time, $follow_unfollow_delay, $speed, $follow_min_follower, $follow_max_follower, $unfollow_unfollowed, $follow_quota, $unfollow_quota, $proxy);
...
if (!function_exists('getCommentProfiles')) {
    ...
    function getCommentProfiles($email, $tier, $servername, $username, $password, $dbname) {
        ...
        $get_comment_profile_sql = "SELECT DISTINCT(insta_username),
                ...
                AND ((comment_feedback_required = 0 AND auto_comment_ban = 0) OR (auto_comment_ban = 1 AND NOW() >= auto_comment_ban_time))
