...
<div class="row lead-details">
    ...
    <div class="col-sm-6">
        ...
        <span>
            ...
            <p>
                Morfix Teamw will send a personalized Direct Message of your settings to your new followers.
            </p>
        </span>
        <span>
            <span class="header"><li class="fa fa-fast-forward"></li>Follow-Up Message</span>
            <p>
...
<div class="row lead-details">
    <div class="col-sm-6">
        ...
        <span>
            <span class="header"><li class="fa_prepended fa fa-users"></li>Morfix Team Interacts With Them</span>
            <p>
...
<div class="row lead-details">
    ...
    <div class="col-sm-6">
        ...
        <span>
            ...
            <p>
                Simply upload your content and schedule a  date and time and the Morfix team will post your content for you.
            </p>
        </span>
        <span>
            <span class="header"><li class="fa_prepended fa fa-comments-o"></li>No More Awful Looking Captions</span>
            <p>
               Hashtags is an important tool to increase engagement. But too many hashtags in the captions can be awful to look at.
            </p>
            <p>
                Therefore you can set your hashtags in the comments settings and Morfix will input your hashtags in your first comment when posting your content.
            </p>
        </span>
        <button>Join Now</button>
    </div>
