...
$one->main_nav                     = array(
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Pages Packs</span>',
        'type'  => 'heading'
    ),
    array(
    ...
    array(
        'name'  => '<span class="sidebar-mini-hide">Travel</span>',
        'icon'  => 'si si-plane',
        'sub'   => array(
            array(
                'name'  => 'Agency',
                'url'   => 'frontend_travel_agency.php'
            ),
            array(
                'name'  => 'Package',
                'url'   => 'frontend_travel_package.php'
            ),
            array(
                'name'  => 'Guide',
                'url'   => 'frontend_travel_guide.php'
            )
        )
    )
);