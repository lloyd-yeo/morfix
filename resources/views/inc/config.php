...
$one->main_nav                     = array(
    ...
    array(
        ...
        'sub'   => array(
            ...
            array(
                'name'  => 'Cards',
                'url'   => 'base_ui_cards.php'
            ),
            array(
                'name'  => 'Ribbons',
                'url'   => 'base_ui_ribbons.php'
            ),
            array(
                'name'  => 'Chat',
                'sub'   => array(
                    array(
                        'name'  => 'Full',
                        'url'   => 'base_ui_chat_full.php'
                    ),
                    array(
                        'name'  => 'Fixed',
                        'url'   => 'base_ui_chat_fixed.php'
                    ),
                    array(
                        'name'  => 'Popup',
                        'url'   => 'base_ui_chat_popup.php'
                    )
                )
            ),
            array(
                ...
                'sub'   => array(
                    ...
                    array(
                        'name'  => 'Social',
                        'url'   => 'base_ui_timeline_social.php'
                    )
                )
            ),
            array(
    ...
    array(
        ...
        'sub'   => array(
            ...
            array(
                'name'  => 'Rating',
                'url'   => 'base_comp_rating.php'
            ),
            array(
                'name'  => 'Tree View',
                'url'   => 'base_comp_treeview.php'
            ),
            array(
                'name'  => 'Maps',
                'sub'   => array(
                    ...
                    array(
                        'name'  => 'Google Full',
                        'url'   => 'base_comp_maps_full.php'
                    ),
                    array(
                        'name'  => 'Vector',
                        'url'   => 'base_comp_maps_vector.php'
                    )
                )
            ),
            array(
    ...
    array(
        ...
        'sub'   => array(
            ...
            array(
                'name'  => 'Dashboard v2',
                'url'   => 'base_pages_dashboard_v2.php'
            ),
            array(
                'name'  => 'Search Results',
            ...
            array(
                'name'  => 'Files',
                'url'   => 'base_pages_files.php'
            ),
            array(
                'name'  => 'Tickets',
                'url'   => 'base_pages_tickets.php'
            ),
            array(
                'name'  => 'Contacts',
                'url'   => 'base_pages_contacts.php'
            ),
            array(
                'name'  => 'Coming Soon',
            ...
            array(
                'name'  => 'Coming Soon v2',
                'url'   => 'base_pages_coming_soon_v2.php'
            ),
            array(
                'name'  => 'Maintenance',
                'url'   => 'base_pages_maintenance.php'
            )
        )
    ),
    array(
        ...
        'sub'    => array(
            array(
                'name'  => 'Dashboard',
                'url'   => 'base_pages_ecom_dashboard.php'
            ),
            array(
                'name'  => 'Orders',
                'url'   => 'base_pages_ecom_orders.php'
            ),
            array(
                'name'  => 'Order',
                'url'   => 'base_pages_ecom_order.php'
            ),
            array(
                'name'  => 'Products',
                'url'   => 'base_pages_ecom_products.php'
            ),
            array(
                'name'  => 'Product Edit',
                'url'   => 'base_pages_ecom_product_edit.php'
            ),
            array(
                'name'  => 'Customer',
                'url'   => 'base_pages_ecom_customer.php'
            )
        )
    ),
    array(
        ...
        'sub'   => array(
            ...
            array(
                'name'  => 'Profile v2',
                'url'   => 'base_pages_profile_v2.php'
            ),
            array(
                'name'  => 'Profile Edit',
                'url'   => 'base_pages_profile_edit.php'
            )
        )
    ),
    array(
        ...
        'sub'   => array(
            array(
                'name'  => 'Categories',
                'url'   => 'base_pages_forum_categories.php'
            ),
            array(
                'name'  => 'Topics',
                'url'   => 'base_pages_forum_topics.php'
            ),
            array(
                'name'  => 'Discussion',
                'url'   => 'base_pages_forum_discussion.php'
            ),
            array(
                'name'  => 'New Topic',
                'url'   => 'base_pages_forum_new_topic.php'
            )
        )
    ),
    array(
        ...
        'sub'   => array(
            ...
            array(
                'name'  => 'Register v2',
                'url'   => 'base_pages_register_v2.php'
            ),
            array(
                'name'  => 'Lock Screen',
            ...
            array(
                'name'  => 'Password Reminder v2',
                'url'   => 'base_pages_reminder_v2.php'
            )
        )
    ),
    array(
