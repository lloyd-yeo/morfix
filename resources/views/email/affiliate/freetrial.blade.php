...
<html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]-->
	<head>
		...
		<meta property="og:title" content="Premium Congrats"></meta>
	</head>
                                                                         <!--[if mso]>
	<body class='mso'>
                                                                         <![endif]-->
			...
			<td>
				<div role="banner">
					...
					<div class="header"
						...
						<div class="logo emb-logo-margin-box"
						     ...
						     align="center">
							<div class="logo-left" align="left" id="emb-email-header"><img
										style="display: block;height: auto;width: 100%;border: 0;max-width: 219px;"
										src="https://i1.createsend1.com/ei/j/1D/DC2/189/153939/csfinal/morfix-dark-logo-3.png"
										alt="" width="219"></div>
						</div>
						<!--[if (mso)|(IE)]></td></tr></table><![endif]-->
					</div>
				...
				<div role="section">
							...
							<div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
								...
								<div class="column"
									...
									<div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;"
									     align="center">
										<img style="border: 0;display: block;height: auto;width: 100%;max-width: 600px;"
										     alt="" width="600"
										     src="https://i1.createsend1.com/ei/j/1D/DC2/189/153939/csfinal/congrats.png">
									</div>

									<div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
										<div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
											<h2 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #e31212;font-size: 26px;line-height: 34px;font-family: sans-serif;text-align: center;">
												<span class="font-sans-serif">NEW FREE-TRIAL REFERRAL!</span></h2>
										</div>
									</div>
					...
					<div class="has-border"
					     style="background-color: #ffffff;border-top: 1px solid #ccc;border-bottom: 1px solid #ccc;">
						<div class="layout one-col"
						     style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
							<div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
								<!--[if (mso)|(IE)]>
								<table class='layout-has-border' width='100%' cellpadding='0' cellspacing='0'
								       role='presentation'>
								...
								<div class="column"
									...
									<div style="Margin-left: 20px;Margin-right: 20px;">
										<div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
											<p class="size-14"
											   style="Margin-top: 0;Margin-bottom: 0;font-family: sans-serif;font-size: 14px;line-height: 21px;text-align: left;"
											   lang="x-size-14"><span class="font-sans-serif">&nbsp;</span></p>
											<p class="size-14"
											   style="Margin-top: 20px;Margin-bottom: 0;font-family: sans-serif;font-size: 14px;line-height: 21px;text-align: left;"
											   lang="x-size-14"><span class="font-sans-serif"><span
															style="color:#18527c">Hey {{ $referrer_name }}
											                                      !</span></span></p>
											<p class="size-14"
											   style="Margin-top: 20px;Margin-bottom: 0;font-family: sans-serif;font-size: 14px;line-height: 21px;text-align: left;"
											   lang="x-size-14"><span class="font-sans-serif"><span
															style="color:#18527c">Congratulations! </span></span></p>
											<p class="size-14"
											   style="Margin-top: 20px;Margin-bottom: 0;font-family: sans-serif;font-size: 14px;line-height: 21px;text-align: left;"
											   lang="x-size-14"><span class="font-sans-serif"><span
															style="color:#18527c">You've just gained a new referral!&nbsp;<br>
Your referral&nbsp;[{{ $referred_email }}] has just signed up for Morfix!<br>
<br>
To view more information about your referrals&nbsp;you can simply click&nbsp;<a
																style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #18527c;"
																href="https://app.morfix.co/affiliate">here</a>.</span></span>
											</p>
											<p class="size-14"
											   style="Margin-top: 20px;Margin-bottom: 0;font-family: sans-serif;font-size: 14px;line-height: 21px;text-align: left;"
											   lang="x-size-14"><span class="font-sans-serif"><span
															style="color:#18527c">Keep up the good work!<br>
<strong>Morfix Team</strong></span></span></p>
											<p class="size-14"
											   style="Margin-top: 20px;Margin-bottom: 0;font-family: sans-serif;font-size: 14px;line-height: 21px;text-align: left;"
											   lang="x-size-14"><span class="font-sans-serif">&nbsp;</span></p>
										</div>
							...
							<div class="column"
								...
								<div style="Margin-left: 20px;Margin-right: 20px;">
									<div class="btn btn--flat btn--large" style="text-align:center;">
										<![if !mso]>
										<a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff !important;background-color: #e31212;font-family: sans-serif;"
										   href="https://app.morfix.co/login">Login Here!
										</a>
										<![endif]>
										<!--[if mso]><p style='line-height:0;margin:0;'>&nbsp;</p>
										<v:roundrect xmlns:v='urn:schemas-microsoft-com:vml'
										             href='https://app.morfix.co/login' style='width:126px' arcsize='9%'
										             fillcolor='#E31212' stroke='f'>
							...
							<div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
								...
								<table align='center' cellpadding='0' cellspacing='0' role='presentation'>
									<tr class='layout-email-footer'>
										<td style='width: 600px;' class='w560'><![endif]-->
								<div class="column"
								     style="text-align: left;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
									<div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
										<div style="font-size: 12px;line-height: 19px;">
											<a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;"
											   href="http://morfix.createsend1.com/t/j-u-oydtytl-l-h/">Unsubscribe
											</a>
										</div>
									</div>
								</div>
	...
	<img style="overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;"
	     src="https://morfix.createsend1.com/t/j-o-oydtytl-l/o.gif" width="1" height="1" border="0" alt="">
	<script type="text/javascript"
	        src="https://js.createsend1.com/js/jquery-1.7.2.min.js?h=C99A4659201709040201"></script>
