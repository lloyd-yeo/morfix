...
<html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]-->
	<head>
		...
		<!--[if !mso]><!-->
		<style type="text/css">
			@import url(https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic|Raleway:400,700,400italic|Roboto:400,700,400italic,700italic);
		</style>
		<link href="https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic|Raleway:400,700,400italic|Roboto:400,700,400italic,700italic"
		...
		<meta property="og:title" content="[Morfix] Profile Verification Required!">
	</head>
                                                                         <!--[if mso]>
	<body class='mso'>
                                                                         <![endif]-->
	...
	<body class="no-padding"
	      style="margin: 0px; padding: 0px; text-size-adjust: 100%; height: 644px; overflow-y: hidden;">
	<!--<![endif]-->
	<table class="wrapper"
				...
				<div role="banner">
					<div class="preheader"
						...
						<div style="border-collapse: collapse;display: table;width: 100%;">
							...
							<div class="snippet"
							     style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #c2c2c2;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">

							</div>
							<!--[if (mso)|(IE)]></td>
							<td style='width: 280px' valign='top'><![endif]-->
							<div class="webversion"
							     style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #c2c2c2;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;">
				...
				<div role="section">
					<div class="layout one-col fixed-width"
						...
						<div class="layout__inner"
							...
							<div class="column"
							     style="text-align: left;color: #595959;font-size: 14px;line-height: 21px;font-family: Roboto,Tahoma,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
...
1 or more of your profiles requires you to clear verification&nbsp;before it can resume auto-interacting with your<strong> Target Audience</strong>, sending out Direct Messages to <strong>New Followers</strong> &amp; <strong>Scheduled Content</strong>!</span>
										...
										<p class="size-14"
										   ...
										   lang="x-size-14">Fret not, re-verification is simple &amp; straightforward
										                    ...
										                    This means you can do everything on your own now!</p>
									</div>
								</div>
								...
								<div style="Margin-left: 20px;Margin-right: 20px;">
									<div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
										<p class="size-17"
										   ...
										   lang="x-size-17">Regards,<br>
											<strong>Morfix Team</strong></p>
									</div>
								</div>
						...
						<div class="layout email-footer"
							...
							<div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
								...
								<div class="column wide"
								     style="text-align: left;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
								...
								<div class="column narrow"
								     style="text-align: left;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(72200px - 12000%);">
									<div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
							...
							<div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
								...
								<table align='center' cellpadding='0' cellspacing='0' role='presentation'>
									<tr class='layout-email-footer'>
										<td style='width: 600px;' class='w560'><![endif]-->
								<div class="column"
								     style="text-align: left;font-size: 12px;line-height: 19px;color: #c2c2c2;font-family: Raleway,Trebuchet MS,Avenir,Segoe UI,sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
									<div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
										<div style="font-size: 12px;line-height: 19px;">
											<a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #c2c2c2;"
											   href="http://morfix.createsend1.com/t/j-u-bdkxjd-l-t/" target="_blank">
												Unsubscribe
											</a>
										</div>
									</div>
	...
	<img style="overflow: hidden;position: fixed;visibility: hidden !important;display: block !important;height: 1px !important;width: 1px !important;border: 0 !important;margin: 0 !important;padding: 0 !important;"
	     src="https://morfix.createsend1.com/t/j-o-bdkxjd-l/o.gif" width="1" height="1" border="0" alt="">
	<script type="text/javascript"
	        src="https://js.createsend1.com/js/jquery-1.7.2.min.js?h=C99A4659201803210443"></script>
	<script type="text/javascript">$(function () {
            $('area,a').attr('target', '_blank');
        });</script>
	<script type="text/javascript" src="https://js.createsend1.com/js/tsb.min.js?h=544AE0C5201803210443"></script>
	<script type="text/javascript">
        var $scroll = $('body');
	...
	<div id="ascrail2000" class="nicescroll-rails"
	     style="width: 12px; z-index: auto; cursor: default; position: fixed; top: 0px; height: 100%; right: 0px; opacity: 0.25;">
		<div style="position: relative; top: 139px; float: right; width: 8px; height: 469px; background-color: rgb(0, 0, 0); border: 2px solid transparent; background-clip: padding-box; border-radius: 10px;"></div>
	</div>
	</body>
</html>