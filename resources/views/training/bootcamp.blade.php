...
@section('sidebar')
@include('sidebar', ['page' => 'training-bootcamp'])
@endsection
...
<main id="main-container">
        ...
        <div class="row items-push">
            <div class="col-sm-12">
                <h1 class="page-heading">
                    <i class="fa fa-2x fa-handshake-o"></i>  Morfix Bootcamp Training <small> Learn from the 3 days Morfix bootcamp that helped our students gain results using Morfix!</small>
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="content content-boxed">
        <div class='row'>
            <div class="col-lg-4">
                <a class="block block-link-hover2" href="#" data-toggle="modal" data-target="#inner-wealth-1">
                    <div class="block-content block-content-full bg-primary clearfix">
                        <i class="fa fa-2x fa-play-circle fa-2x text-white pull-left"></i>
                        <span class="h4 font-w700 text-white">Part 1</span> - <span class="h4 text-white-op">Inner Wealth (Part 1)</span>
                    </div>
                </a>
            </div>
            <div class="col-lg-4">
                <a class="block block-link-hover2" href="#" data-toggle="modal" data-target="#inner-wealth-2">
                    <div class="block-content block-content-full bg-primary clearfix">
                        <i class="fa fa-2x fa-play-circle fa-2x text-white pull-left"></i>
                        <span class="h4 font-w700 text-white">Part 2</span> - <span class="h4 text-white-op">Inner Wealth (Part 2)</span>
                    </div>
                </a>
            </div>
        </div>        
                    ...
                    <div class="block-content">
                        <div class='row'>
                            ...
                            <div class='row push-10-t'>
                                ...
                                <div class="col-lg-4">
                                    <a class="block block-link-hover2" href='https://morfix.co/app/morfix-ebook.pdf' target='_blank' >
                                        <div class="block-content block-content-full bg-primary clearfix">
                                            <i class="fa fa-2x fa-cloud-download text-white pull-left"></i>
