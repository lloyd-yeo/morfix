                                ...
                                <tr>
                                    ...
                                    @if ($ig_profile->auto_follow == 1)
                                        ...
                                        @elseif ($ig_profile->auto_follow_ban == 1)
                                            <td class='text-warning'><i class="fa fa-fw fa-refresh"></i> Throttled by Instagram Temporarily - Next Attempt at {{ Carbon\Carbon::parse($ig_profile->next_follow_time)->toDayDateTimeString() }}</td>
                                        @else
                                            {{-- If error isnt there, proceed as usual --}}
                                            <td class='text-success'><i class="fa fa-fw fa-check-square"></i> Healthy</td>
                                        @endif
