                    ...
                    <div class="/*bg-primary-dark-op*/">
                        <section class="content content-full content-boxed">
                            ...
                            <div class="push-200-t">
                                ...
                                <h2 class="h5 text-white-op animated zoomIn">Welcome {{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->email }}}</h2>
                            </div>
                            <!-- END Section Content -->
                        </section>
                    </div>
...
<!--                                            <div>
            ...
            <footer id="page-footer" class="content-mini content-mini-full font-s12 bg-gray-lighter clearfix">
                ...
                <div class="pull-left">
                    <a class="font-w600" href="http://goo.gl/6LF10W" target="_blank">Morfix 2.0</a> &copy; <span class="js-year-copy"></span>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
