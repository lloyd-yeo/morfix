...
<div class="content">
    ...
    <div class="block">
        <div class="block-header">
            <h3 class="block-title">Font Awesome <small>675 icons with base class <code>fa</code></small></h3>
        </div>
        <div class="block-content">
            <div class="js-icon-list row items-push-2x text-center">
                <div class="col-sm-6 col-lg-3">
                ...
                <div class="col-sm-6 col-lg-3">
                    <p><i class="fa fa-id-badge fa-2x"></i></p>
                    <code>fa-id-badge</code>
                </div>
                <div class="col-sm-6 col-lg-3">
                ...
                <div class="col-sm-6 col-lg-3">
                    ...
                    <code>fa-user-circle</code>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <p><i class="fa fa-user-circle-o fa-2x"></i></p>
                    <code>fa-user-circle-o</code>
                </div>
                <div class="col-sm-6 col-lg-3">
