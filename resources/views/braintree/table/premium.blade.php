            ...
            <div style='padding:5px; background-color:rgb(212, 60, 60); height: 274px;'>
                ...
                <div class="push-20-t text-white" 
                    ...
                    <div class="push-30-t block-title h6 text-white" 
                         style="font-size: 14px; text-transform: none; font-weight: 100;
                         font-style: italic; font-family: 'Lora', serif;">Make Affiliate Commission!</div>
                </div>
            </div>
        </div>
        <div class="block-content" style='padding-top: 0px;
            ...
            <div>
                ...
                <div style='padding-top: 0px; padding-bottom: 20px;'>
                    <a id="submit-button" href='https://upgrade.morfix.co/premium' target="_blank" class="text-white" style='
