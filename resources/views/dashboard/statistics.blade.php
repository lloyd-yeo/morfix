...
<div class="content bg-white border-b">
    <div class="row items-push text-uppercase">
        ...
        <div class="col-xs-6 col-sm-6 col-lg-2">
            ...
            <div class="text-muted animated fadeIn"><small><i class="si si-calendar"></i> <b>6</b> quota remaining <i class="fa fa-question-circle"  data-toggle="tooltip" data-placement="top" title="Remaining instagram slots you can add in Morfix" type="button"></i></small></div>
