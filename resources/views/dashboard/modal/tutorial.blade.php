...
<div class="modal fade" id="dashboard-tutorial-modal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="block block-themed block-transparent">
                <div class="block-header bg-modern">
                    ...
                    <h3 class="block-title">Part 1 - Dashboard</h3>
                </div>
                    ...
                    <div class='row'>
                        ...
                        <div class='col-xs-12'>
                            <label class="css-input css-checkbox css-checkbox-sm css-checkbox-primary">
                                <input id="tut-cbx" type="checkbox" value="1"><span></span> Don't show me this again
                            </label>
                        </div>
