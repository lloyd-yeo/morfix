		...
		<!-- END Dynamic Table Full -->
				...
				<div class="block">
					...
					<div class="block-content">
						<form id="address_form" action="" method="POST">
							...
							<br>
							<button type="button" onclick="save_address();" class="btn btn-primary">Save Address
							</button>
						</form>
						<div style="height: 30px;">
			...
			<div class="block" id="braintree-null">
				...
				<div class="block-content">
					<form method="POST" action="/update-details" id="update_card">
						...
						<button class="btn btn-primary" id="submit-button" type="button"> Save Updated Card Details
						</button>
			...
			@if(Auth::user()->braintree_id != NULL)
				<div class="block" id="braintree-value">
					...
					<div class="block-content">
						<button class="btn btn-primary" id="show-braintree-null" name="submit" type="submit"> Update
						                                                                                      Card
						                                                                                      Details
						</button>
						<div style="height: 30px;">
							...
							<form action="/cancel-subscription" method="POST">
								<div class="tab-content">
									<div class="tab-pane active" id="step1">
										<center>
											<img src="https://images.typeform.com/images/WXhyJGNcF5iF/image/default#.png"
											     data-original="https://images.typeform.com/images/WXhyJGNcF5iF/image/default#.png"
											     style="width: 400px; height: 400px;">
											<div style="width:70%;">
												<p>
													<strong>
														However, would it be okay to get some feedbacks from you so we
														know how we can hope to serve you better next time?
													</strong>
												</p>
											</div>
										</center>
										<div class="modal-footer">
											<button type="button" class="btn btn-default pull-left"
											        data-dismiss="modal">No, I've change my mind
											</button>
											<button type="button" class="btn btn-primary pull-right">Yes, Go to first
											                                                         question
											</button>
										</div>
									</div>
									<div class="tab-pane" id="step2">
										<center>
											<div style="width:100%;">
												...
												<p></p>
												<button type="button" class="btn btn-default long" style="width: 200px;"
												        onclick="checkValue(this);" value="Less than a week">Less than a
												                                                             week
												</button>
												&nbsp;&nbsp;
												<button type="button" class="btn btn-default long" style="width: 200px;"
												        onclick="checkValue(this);" value="Less than a month">Less than
												                                                              a month
												</button>
												<p></p>
												<button type="button" class="btn btn-default long" style="width: 200px;"
												        onclick="checkValue(this);" value="1 - 3 months">1 - 3 months
												</button>
												&nbsp;&nbsp;
												<button type="button" class="btn btn-default long" style="width: 200px;"
												        onclick="checkValue(this);" value="More than 6 months">More than
												                                                               6 months
												</button>
												</strong>
												</p>
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-primary pull-right"
											        onclick="save_first();">Yes, Go to second question
											</button>
										</div>
									</div>
									<div class="tab-pane" id="step3">
										<div style="width:100%;">
											...
											<p></p>
											<textarea class="form-control" name="second_question"
										...
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-primary pull-right"
											        onclick="save_second();">Yes, Go to third question
											</button>
										</div>
									</div>
									<div class="tab-pane" id="step4">
										<div style="width:100%;">
											...
											<p></p>
											<textarea class="form-control" name="third_question"
											          style="height:30%"></textarea>
											</strong>
											</p>
										</div>
										<div class="modal-footer">
											...
											<button type="button" class="btn btn-primary pull-right"
											        onclick="save_third();">Yes, Go to last question
											</button>
										</div>
									</div>
									<div class="tab-pane" id="step5">
										<div style="width:100%;">
											<p>
												<strong>
													4. What features would you like to see if you were to come back to
													Morfix?
											<p></p>
											<textarea class="form-control" name="fourth_question"
											          style="height:30%"></textarea>
											</strong>
											</p>
										</div>
										<div class="modal-footer">
											...
											<button type="submit" class="btn btn-primary pull-right">Yes, cancel my
											                                                         subscription
											</button>
										</div>
									</div>
