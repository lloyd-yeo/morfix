                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    <button class="btn btn-xs btn-success btn-pay-invoice" data-sub-id="{{ $subscription->id }}" data-invoice-id="{{ $invoice[$subscription->id] }}" type="button" data-toggle="tooltip" title="Pay Subscription"><i class="fa fa-credit-card"></i></button>
                                </div>
                                @else
                                <div class="btn-group">
