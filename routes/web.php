...
Route::post('/interactions/delete/comment/{id}', 'InteractionsController@saveComment');
Route::post('/interactions/delete/username/{id}', 'InteractionsController@saveUsername');
Route::post('/interactions/delete/hashtag/{id}', 'InteractionsController@saveHashtag');
